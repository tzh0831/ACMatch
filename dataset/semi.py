    ...
    def __getitem__(self, item):
        ...
        if self.mode == 'train_l' or self.mode == 'val':
            ...
            if self.mode == 'val': 
                ...
                img,depth,mask = Normalize()(img,depth,mask)
            ...
            # img,depth,mask,mask2,mask3,mask4,mask5 = ToTensor()(img,depth,mask)
            # return Normalize()(img,depth,mask,mask2,mask3,mask4,mask5)
            img,depth,mask = ToTensor()(img,depth,mask)
            return Normalize()(img,depth,mask)
        ...
        img_w,depth_w = Normalize()(img_w,depth_w)
        img_s1,depth_s1 = Normalize()(img_s1,depth_s1)
        img_s2,depth_s2 = Normalize()(img_s2, depth_s2)
